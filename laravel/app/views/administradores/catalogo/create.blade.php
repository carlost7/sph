      ...
      <div class="row">
            ...
            <div class="col-sm-6">
                  ...
                  <div class="form-group">
                        ...
                        {{ Form::select('categoria_id', $categorias->lists('categoria', 'id'),Input::old('categoria_id'),array('class'=>'form-control')) }}
                  </div>                  
                  <div class="form-group">
      ...
      <div class="row">
            ...
            <div class="col-sm-6">
                  ...
                  <div class="form-group">
                        ...
                        {{ Form::select('estado_id', $estados->lists('estado', 'id'),Input::old('estado_id'),array('class'=>'form-control')) }}
                  </div>
                  <div class="form-group">
