...
{{ Form::open(array('route'=>'publicar.clientes_eventos.store')) }}
...
<div class="form-group">
      ...
      {{ Form::textArea('descripcion', Input::old('descripcion'), array('placeholder' => 'Descripción del evento', 'class'=>'form-control')) }}
</div>
<div class="form-group">
      {{ Form::label('direccion', 'Dirección') }}
      {{ Form::text('direccion', Input::old('direccion'), array('placeholder' => 'dirección del evento', 'class'=>'form-control')) }}
</div>
<div class="form-group">
