...
class UnitTest extends PHPUnit_Framework_TestCase
{
      ...
      public function testCreatePreference()
      {
            ...
            $this->assertTrue($preference["response"]["items"][0]["title"] == "test1" && (int) $preference["response"]["items"][0]["quantity"] == 1 && (double) $preference["response"]["items"][0]["unit_price"] == 10.2 && $preference["response"]["items"][0]["currency_id"] == "ARS");
      }
      ...
      public function testUpdatePreference()
      {
            ...
            $this->assertTrue((double) $preferenceUpdatedResult["response"]["items"][0]["unit_price"] == 100 && (double) $preferenceUpdatedResult["response"]["items"][0]["quantity"] == 2 && $preferenceUpdatedResult["response"]["items"][0]["title"] == "test2Modified" && $preferenceUpdatedResult["response"]["items"][0]["currency_id"] == "USD");
      }
