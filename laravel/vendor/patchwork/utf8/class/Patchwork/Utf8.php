...
class Utf8
{
      ...
      static function strstr($s, $needle, $before_needle = false)
      {
            return grapheme_strstr($s, $needle, $before_needle);
      }

      static function strrchr($s, $needle, $before_needle = false)
      {
      ...
      static function number_format($number, $decimals = 0, $dec_point = '.', $thousands_sep = ',')
      {
            ...
            /**/
            {
                  ...
                  {
                        return str_replace(
                                array('.', ','), array($dec_point, $thousands_sep), number_format($number, $decimals, '.', ',')
                        );
                  }
                  /**/
            }
      ...
      protected static function rxClass($s, $class = '')
      {
            ...
            foreach (self::str_split($s) as $s)
            {
                  ...
                  else if (1 === iconv_strlen($s, 'UTF-8'))
                        $class[0] .= $s;
                  else
                        $class[] = $s;
            }
